# celo-personality - Smart Contracts

This directory contains the smart contracts for celo-personality, built with Hardhat and optimized for the Celo blockchain.
